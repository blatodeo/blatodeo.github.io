...
<div class="col-xs-12">
  ...
  <!-- <p> Mostrar cantidad de <select name="sel" id="value"> 
    ...
    <br>
    <div>
    <a class="btn btn-primary" href="registro.php"> Nuevo Usuario <i class="fa fa-plus" aria-hidden="true"></i></a>
      ...
      <a class="btn btn-dark" href="../producto/productos.php">Productos <i class="fa fa-box" aria-hidden="true"></i> </a>
