...
.pag_btn {
 ...
 .pag_num {
  ...
  <title>Lineas de Materia Prima</title>
</head>
...
<div class="container is-fluid">
  ...
  <br>
  <div class="col-xs-12">
    <h1>Lista de Lineas de Materia Prima</h1>
      <a class="btn btn-success" href="excel.php">Excel
       ...
       <a class="btn btn-primary" href="agregar_linea.php"> Nueva Linea
        <i class="fa fa-plus" aria-hidden="true"></i>
      </a>
      <a class="btn btn-primary" href="../mp/mp.php"> Regresar a Materias Primas
      ...
      <tbody>
        ...
        ?>
            <tr>
              ...
              <td>
                <a class="btn btn-warning" href="editar_linea.php?id=<?php echo $fila['id'] ?> ">
                  <i class="fa fa-edit"></i> </a>

                <a class="btn btn-danger" href="eliminar_linea.php?id=<?php echo $fila['id'] ?>">
